...
indexContent = indexContent
  ...
  <link rel="stylesheet" href="./triple-slider.css">
...
const scssContentLib = fs
  .readFileSync('./demo-vite/triple-slider.scss', 'utf-8')
  .split('\n')
...
// JS
let jsContentLib = fs.readFileSync('./demo-vite/triple-slider.js', 'utf-8');
...
fs.writeFileSync('./demo-static/triple-slider.css', cssContentLib);
fs.writeFileSync('./demo-static/main.css', cssContent);
fs.writeFileSync('./demo-static/triple-slider.js', jsContentLib);
