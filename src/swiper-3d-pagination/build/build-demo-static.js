...
indexContent = indexContent
  ...
  <link rel="stylesheet" href="./swiper-cubes.css">
  ...
  <script src="./swiper-cubes.js"></script>
...
const scssContentLib = fs
  .readFileSync('./demo-vite/swiper-cubes.scss', 'utf-8')
  .split('\n')
...
// JS
let jsContentLib = fs.readFileSync('./demo-vite/swiper-cubes.js', 'utf-8');
...
fs.writeFileSync('./demo-static/swiper-cubes.css', cssContentLib);
fs.writeFileSync('./demo-static/main.css', cssContent);
fs.writeFileSync('./demo-static/swiper-cubes.js', jsContentLib);
